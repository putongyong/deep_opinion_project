...
from src.repositories import sql_repository
...
def create_user_input():
    ...
    try:
        ...
        db_user_input = sql_repository.create_user_input(db, output_data)
...
def read_user_input(user_input_id: str):
    ...
    """
    db: Session = next(get_db())
    db_user_input = sql_repository.get_user_input_by_id(db, user_input_id)
...
def read_all_user_inputs():
    ...
    try:
        ...
        user_inputs = sql_repository.get_all_user_inputs(db, skip=offset, limit=limit)
